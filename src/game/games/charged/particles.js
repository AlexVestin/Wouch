...
// OPACITY
var particleOpacity = 0.45; // opacity of primary particles
var bokehOpacity = 0.5; // opacity of bokeh (raising this above 0.5 results in weird behavior)
// SIZE
var minParticleSize = 2; // the minimum size scalar for particle systems
var maxParticleSize = 6; // the maximum size scalar for particle systems
...
var zPosBias = 10.3; // bias for particle z-positions (higher values = more far-biased)
...
var frustumPadding = 0; // the units to pad the frustum by
...
export default  class Particles  {
    ...
    updateParticles() {
        ...
        for (var i = 0; i < particles.vertices.length; i++) {
            ...
            if (particle.x > 1 && !this.isInView(particle)) {
